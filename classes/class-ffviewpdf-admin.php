...
class FfViewPdfAdmin {
	...
	public function settings_init() {
	    ...
	    \add_settings_section(
	        ...
	        __( 'PDF Settings.', 'ffviewpdf' ), array( $this, 'section_defaults_callback' ),
	        'ffviewpdf'
	    );
	 ...
	 * @param array $args
	 */	
	function field_filename_callback( $args ) {
	    $options = \get_option( 'ffviewpdf_options' );
	    ?>
	    <input type="text" 
	            id="<?php echo esc_attr( $args['label_for'] ); ?>"
	 ...
	 * @param array $args
	 */
	function field_scripttolang_callback( $args ) {
	    $options = \get_option( 'ffviewpdf_options' );
	 ...
	 * @param array $args
	 */
	function field_langtofont_callback( $args ) {
	    $options = \get_option( 'ffviewpdf_options' );
	    ?>
		<input type="checkbox" 
	            id="<?php echo esc_attr( $args['label_for'] ); ?>"
